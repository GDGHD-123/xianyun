    ...
    <el-form class="search-form-content" ref="form" label-width="80px">
      ...
      <el-form-item label="到达城市">
        <el-autocomplete
          ...
          placeholder="请搜索到达城市"
          @select="(item)=>handleSelect(item,'dest')"
          class="el-autocomplete"
...
export default {
  ...
  methods: {
    ...
    handleSearchTab(item, index) {
      if (index === 1) this.$message.warning("暂时还没有往返功能");
    },
    ...
    handleSubmit() {
      ...
      const rules = [
        ...
        { message: "请输入出发日期", value: this.form.departDate }
      ];
      var bool = rules.some(v => {
        if (!v.value) {
